...
const promptLibraryAssets = promptLibrarySeed.map(([title, model, category, quarter, prompt], index) => ({
  ...
  title,
  mediaType: "image",
  mediaUrl: `/aigc-assets/prompt/prompt-${String(index + 1).padStart(3, "0")}.webp`,
  model,
  category,
  scene: "Prompt 素材",
  quarter,
